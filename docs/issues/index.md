...
<table border="1" class="dataframe table table-striped table-hover table-sm" id="issues_table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>ERROR</td>
      <td>Invalid resources.url.status_code: 502 for resources[1].url=https://dspace.library.uvic.ca/handle/1828/9312</td>
    </tr>
    <tr>
      <td>2024-03-21</td>
      <td>Real-Time Provisional High-Resolution Record of Surface Seawater Carbon Dioxide (CO2) Content Collected from the Ketchikan Shellfish Hatchery, Alaska, USA</td>
