...
| level   | message                                                                                                      |
|:--------|:-------------------------------------------------------------------------------------------------------------|
| ERROR   | Invalid resources.url.status_code: 420 for resources[4].url=https://doi.org/10.1109/PACRIM47961.2019.8985053 |
| ERROR   | Invalid resources.url.status_code: 420 for resources[5].url=https://doi.org/10.1109/IGARSS.2012.6351194      |
