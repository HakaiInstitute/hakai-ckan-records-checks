...
| Issue                                                                                                                                     |
|:------------------------------------------------------------------------------------------------------------------------------------------|
| Metadata mismatch: related identifier 'dx.doi.org/10.17504/protocols.io.eq2lywxwpvx9/v1' (IsSupplementedBy) in DataCite not found in CKAN |
